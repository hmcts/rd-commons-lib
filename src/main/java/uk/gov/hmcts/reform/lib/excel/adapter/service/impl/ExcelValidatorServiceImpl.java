...
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.ERROR_PARSING_EXCEL_FILE_ERROR_MESSAGE;
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.FILE_NOT_EXCEL_TYPE_ERROR_MESSAGE;
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.FILE_NOT_PRESENT_ERROR_MESSAGE;
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.FILE_PASSWORD_PROTECTED_ERROR_MESSAGE;
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.TYPE_XLS;
import static uk.gov.hmcts.reform.lib.util.ExcelAdapterConstants.TYPE_XLSX;
import static uk.gov.hmcts.reform.lib.util.WorkBookCustomFactory.validateAndGetWorkBook;
